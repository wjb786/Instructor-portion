	...
	if(userId == null){
	 ...
	 var sql="SELECT * FROM `users` WHERE `id`='"+userId+"'";
	   ...
	   db.query(sql, function(err, results){
		   ...
		   res.render('/student/home.ejs', {id:userId,user:user,data:results, title: 'Home', fullname: fullname});	 
   ...
   if(req.method == "POST"){
	...
	var deletesql="DELETE FROM `tbl_courses` where course_id='"+course_id+"'"; 
	   db.query(deletesql, function(err, result){
	    ...
	    if (err) throw err;
    console.log("Succesfully!  record deleted: ");
   ...
   if(req.method == "POST"){
	...
	var sql="SELECT * FROM `tbl_quizzes` INNER JOIN users ON users.id=tbl_quizzes.user_id where tbl_quizzes.user_id='"+userId+"'";
	   ...
	   db.query(sql, function(err, results){
		...
		message = "No records found!";
		   // console.log(results);		   
		res.render('quizzes.ejs', {id:userId,user:user,data:results,message: message,title: 'Quizzes',fullname: fullname});	  
...
// console.log(sql);
      var query = db.query(sql, function(err, result) {
         ...
         message = "Succesfully! Your quiz has been created.";
